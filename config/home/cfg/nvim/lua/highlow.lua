...
local background_ =         p(57,  7.0, 93.0)
local darkbackground =      p(57, 12.0, 89.0)
local verydarkbackground =  p(57, 17.0, 85.0)
local highlightbackground = p(57, 50.0, 82.0)

local foreground_ =      p(281, 10.0, 10.0)
local foreground_a =     a(foreground_)
local foreground_aa =    a(a(foreground_))

local grey =    p(64, 19.0, 33.0)
local grey_d =  p(64, 19.0, 44.0)
local grey_dd = p(64, 19.0, 55.0)
...
local red_pd =    pa(d(red))
local red_pdd =   pa(d(d(red)))
...
function M.setup()
    if vim.o.background == "dark" then
        ...
        Color.new('red_pd',    invertHslToString(red_pd))
        Color.new('red_pdd',   invertHslToString(red_pdd))
        ...
        Color.new('red_pd',    hslToString(red_pd))
        Color.new('red_pdd',   hslToString(red_pdd))
    ...
    Group.new("HopNextKey",   colors.red_a,   nil, styles.bold)
    Group.new("HopNextKey1",  colors.red_a,   nil, styles.bold)
    Group.new("HopNextKey2",  colors.red_pd, nil, styles.bold)
    Group.new("HopUnmatched", colors.grey_dd)
